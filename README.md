...
| Script | What it does |
| --- | --- |
| `Evaluation indicator.r` | Compares reference against predicted values for all 54 extracted variables and writes the performance metrics to a multi-sheet workbook.|
